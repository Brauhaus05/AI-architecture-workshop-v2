  ...
  <header className="sticky top-0 z-50 w-full bg-background-dark/80 backdrop-blur-md border-b border-grid-line">
    <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
      ...
      <nav className="flex items-center gap-8">
        ...
        <button className="bg-primary text-white font-mono text-xs font-bold px-6 py-2 hover:brightness-110 transition-all cursor-pointer">
          APPLY NOW_
        </button>
      </nav>
    </div>
  ...
  <section className="relative border-b border-grid-line overflow-hidden">
    <div className="max-w-7xl mx-auto px-6 py-24 md:py-32 grid lg:grid-cols-2 gap-16 items-center">
      <div className="z-10">
        ...
        >
          <button className="bg-primary text-white font-mono px-10 py-4 text-sm font-bold hover:translate-x-1 hover:-translate-y-1 transition-transform shadow-[4px_4px_0px_0px_rgba(255,107,0,0.3)] uppercase cursor-pointer">
            Apply Now
          </button>
          <button className="border border-grid-line bg-surface/50 font-mono px-10 py-4 text-sm font-bold hover:bg-surface transition-colors uppercase cursor-pointer">
            Join Waitlist
          </button>
        </motion.div>
      </div>
...
const GalleryPreview = () => (
  <section className="py-24 max-w-7xl mx-auto px-6 border-b border-grid-line">
      ...
      <div className="relative group">
        ...
        >
          ...
          <div className="relative overflow-hidden aspect-video">
            <img alt="High-impact architectural render" className="w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-700" src="https://lh3.googleusercontent.com/aida-public/AB6AXuD1bWFH7MozgGxboSlVJ5pfUluqBR8B3myhablsVVnZI2CrSfg7k0TUip60uuSgRJfWdwkWBdePlIF5xAwS2QFzbJOxotEBnU7momPSB8BGISnEw0pcl8MwK0rWlCUagl7xCsWBgpzsx34y-lhlD-NRbzlqcb5kPwvyJI-oax9-ZMNsqXn2q1UGlY6_EjwVbMzr1gYWIY1ZI95TJANVMWEal5_uICFFDA2_iDu6u0B83V2TgQftJ3CaBENQzWzxVb-vFjH5gAMoj6-t" />
      ...
      <div className="grid md:grid-cols-2 gap-8">
        <div className="relative group">
          ...
          >
            <Crosshairs />
            <div className="relative overflow-hidden aspect-video">
              <img alt="Architectural detail perspective" className="w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-700" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAUgQIFFI05tqnwYPme-GGNsEQdfShyy5-VD5unfu8VdpT4eGHzHERwNNNNu9snAMtydAmglMgeFlxm9iOrYl_MfomuNjgnUUzD-OR_oq7L0g8ji1vTBLL084t10N4SNeGQIlaYr4EbepvW8P8rPMED1KGkE6jeu43PDnzlAx9wctaqqrf24ICGwMKW1gZfAy4-AZcWSI8_CDmX_quJacp0Kjm9O4ndu2hGw2KuNS1x6Yi6mwStI1aVxFhXShBSR4aBy_k3p3sHYD8J" />
        ...
        <div className="relative group">
          ...
          >
            <Crosshairs />
            <div className="relative overflow-hidden aspect-video">
              <img alt="Alternative architectural concept" className="w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-700" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBzIQI4Q_yXLAWXHt3mORXtFmSStzsq82MWCWFVTWD3dC_GwjPQm3WVQB-5nNzG4h4rPLVK8LQNCAg-OCmmy7gqRPIjXDj9hUG4QOk1oVikNnCIm_ikv-hd6jox97J2tAi0XnBtSGsA7RT07l9QBMSD3-dTVysIkbCTUF8gKc5rFtjxvRkL2J202C0WuFc6Wii4EQGgN92QYixs2j28QA6i09U3mXG36yEd7hA6-FeitFLrU5FrtpAJmVca4K06cc9riKW53R8C7sGK" />
...
const ArchiveGallery = () => {
  ...
  return (
    <section className="py-24 border-t border-grid-line bg-background-dark/50" id="archive_gallery">
      <div className="max-w-7xl mx-auto px-6">
            ...
            >
              <div className="blueprint-border bg-surface p-1 transition-all duration-300 group-hover:border-primary">
                ...
                <div className={`relative overflow-hidden ${img.aspect}`}>
                  <img alt={`Gallery image ${i}`} className="w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-700 scale-105 group-hover:scale-100" src={img.src} />
                </div>
        ...
        <div className="mt-16 flex flex-col items-center gap-8">
          ...
          <button className="group relative flex items-center justify-center px-10 py-4 bg-transparent border border-primary text-primary font-mono font-bold text-xs tracking-[0.2em] transition-all hover:bg-primary/10 rounded-none uppercase cursor-pointer">
...
const TechStack = () => {
  ...
  return (
    <section className="py-12 border-y border-grid-line overflow-hidden bg-surface/20" id="stack">
      <div className="flex animate-marquee whitespace-nowrap">
        <div className="flex items-center gap-24 px-12">
          {items.map((item, i) => (
            <span key={i} className="font-display text-4xl font-bold text-muted hover:text-white transition-colors cursor-default">{item}</span>
          ))}
        </div>
        <div className="flex items-center gap-24 px-12">
          {items.map((item, i) => (
            <span key={`dup-${i}`} className="font-display text-4xl font-bold text-muted hover:text-white transition-colors cursor-default">{item}</span>
          ))}
        </div>
      </div>
    </section>
  ...
  <section className="py-24 max-w-7xl mx-auto px-6" id="instructor">
    <div className="grid lg:grid-cols-2 gap-16 items-center">
      ...
      >
        ...
        <div className="blueprint-border p-4">
          <div className="relative aspect-square overflow-hidden grayscale contrast-125 brightness-90 transition-all group-hover:grayscale-0 group-hover:contrast-100">
            <img alt="Braulio Brauhaus portrait" className="w-full h-full object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuC9Aq47LEUt8oafwshmraVg8XoqIXszP424UifX0t8ITh1UhZ75VIwLUlltrNK3vm66kdAXG12QhlmaqCgqZjxR8euBUwYOu5-AeImXKBt9RZXDtpEzN0_g3LW5sjFbiNZgEcJps7iG41CTIQMEiNK_3cmxNSd_uian8AuWIyjFT-s4DBHo9GNfrxrwYFeU6JE0HUryfikckhhg8JVWql09EcvBBQEmcRsxhVnJJsqvmwT2AhzlHODmKxcWhbMgc41lBLVBGc-KXzg6" />
      ...
      >
        ...
        <h2 className="font-display text-4xl md:text-5xl font-bold text-white mb-8 tracking-tighter">BRAULIO “BRAUHAUS”</h2>
  ...
  <section className="py-24 border-t border-grid-line bg-primary/5">
    <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-16">
      <div className="blueprint-border p-8 bg-surface">
        ...
        <button className="w-full border border-primary text-primary font-mono py-4 text-xs font-bold hover:bg-primary hover:text-white transition-all uppercase cursor-pointer">
  ...
  <footer className="bg-background-dark border-t border-grid-line py-20">
    <div className="max-w-7xl mx-auto px-6 text-center">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-6">
        <button className="bg-primary text-white font-mono px-12 py-5 text-lg font-bold hover:scale-105 transition-transform uppercase cursor-pointer">
          Apply Now
        </button>
        <button className="border border-grid-line text-white font-mono px-12 py-5 text-lg font-bold hover:bg-surface transition-colors uppercase cursor-pointer">
          Join Waitlist
        </button>
      </div>
